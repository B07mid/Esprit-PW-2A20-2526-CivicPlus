...
<head>
  ...
  <link href="../../../assets/css/admin.css?v=20260502-1" rel="stylesheet" />
</head>
        ...
        <form action="../Controller/update_user.php" method="POST">
          ...
          <div class="row g-3">
            <div class="col-md-6">
              ...
              <input type="text" inputmode="numeric" maxlength="8" pattern="[0-9]{8}" name="num_cin" class="form-control" value="<?= htmlspecialchars($citoyen['num_cin']) ?>" required>
            </div>
            ...
            <div class="col-md-6">
              ...
              <input type="text" inputmode="tel" maxlength="15" name="numero_telephone" class="form-control" value="<?= htmlspecialchars($citoyen['numero_telephone'] ?? '') ?>">
            </div>
            ...
            <div class="col-md-4">
              ...
              <input type="text" inputmode="numeric" maxlength="4" pattern="[0-9]{4}" name="code_postal" class="form-control" value="<?= htmlspecialchars($citoyen['code_postal'] ?? '') ?>">
            </div>
...
<script src="../../../assets/js/auth.js?v=20260503-1"></script>
  <script src="/civicplus/assets/js/load_admin_sidebar.js?v=20260502-4"></script>
</body>
</html>
