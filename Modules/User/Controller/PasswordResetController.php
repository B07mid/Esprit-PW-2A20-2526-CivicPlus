...
try {
    ...
    if ($action === 'changer_mot_de_passe') {
        ...
        $passwordErrors = cp_password_errors($motDePasse, $confirmation, 6);

        if (!empty($passwordErrors) && in_array('Le mot de passe doit contenir au moins 6 caracteres.', $passwordErrors, true)) {
