...
class SignalementController {
    public function getAllAction($pdo) {
        ...
        echo json_encode(array_values($signalements));
        exit();
    }
            ...
            foreach ($signalements as $sig) {
                ...
                if ($interv) {
                    ...
                    $iObj = new Intervention(
                        ...
                        $interv['commentaires_techniques']
                    );
                ...
                // MÉTIER : Taux de réussite de la zone
                $sig['taux_reussite_zone'] = Signalement::getTauxReussiteZone($pdo, $sig['description']);
