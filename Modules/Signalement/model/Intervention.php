...
class Intervention {
    ...
    public static function getBySignalement($pdo, $id_signalement) {
        $sql = "SELECT * FROM intervention_maintenance WHERE id_signalement = :id_sig";
    ...
    public function ajouterIntervention($pdo) {
        $sql = "INSERT INTO intervention_maintenance (id_signalement, type_intervention, equipe_responsable, date_planification, statut_intervention, commentaire_technicien) 
    ...
    public static function supprimerIntervention($pdo, $id) {
        $sql = "DELETE FROM intervention_maintenance WHERE id_intervention = :id";
        $stmt = $pdo->prepare($sql);
    ...
    public static function getChargeEquipe($pdo, $equipe) {
        $sql = "SELECT COUNT(*) as nb FROM intervention_maintenance WHERE equipe_responsable = :equipe AND statut_intervention != 'termine'";
        $stmt = $pdo->prepare($sql);
