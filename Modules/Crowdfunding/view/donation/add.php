...
<head>
  ...
  <title>Add a Donation - CivicPlus</title>
      ...
      <div class="container">
        ...
        <nav class="breadcrumbs">
          <ol>
            ...
            <li class="current">Add a Donation</li>
          </ol>
        </nav>
      </div>
    </div>
    ...
    <section class="section">
      <div class="container" data-aos="fade-up">
        <div class="row justify-content-center">
          <div class="col-lg-7">
            <h2 class="mb-1">Add a Donation</h2>
            <p class="text-muted mb-4">Fill in the details below to register a new donation.</p>
            ...
            <form method="post" action="index.php?entity=donation&action=add" id="donationForm" novalidate>
              ...
              <div class="mb-3">
                ...
                <input type="number" id="id_projet" name="id_projet" min="1" class="form-control"
                       value="<?= htmlspecialchars($old['id_projet'] ?? '') ?>">
              ...
              <div class="mb-3">
                ...
                <input type="number" id="montant" name="montant" min="0.01" step="any"
                       placeholder="e.g. 100.00" class="form-control"
              ...
              <div class="mb-3">
                ...
                <input type="text" id="reference_transaction" name="reference_transaction" maxlength="100"
                       placeholder="e.g. TXN-20260412-001" class="form-control"
                       value="<?= htmlspecialchars($old['reference_transaction'] ?? '') ?>">
              ...
              <div class="mb-3">
                ...
                <select id="statut_paiement" name="statut_paiement" class="form-select">
                  <option value="" disabled <?= empty($old['statut_paiement']) ? 'selected' : '' ?>>— Select a status —</option>
                  <?php
                    $statuts = ['en_attente' => 'Pending', 'confirmé' => 'Confirmed', 'annulé' => 'Cancelled'];
                    foreach ($statuts as $val => $label):
                      $sel = (($old['statut_paiement'] ?? '') === $val) ? 'selected' : '';
                  ?>
              ...
              <div class="d-flex gap-2">
                ...
                <button type="submit" class="btn btn-primary">
                  <i class="bi bi-check-circle"></i> Add Donation
                </button>
              </div>
