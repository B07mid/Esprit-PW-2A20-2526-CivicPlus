document.addEventListener('DOMContentLoaded', function () {
    ...
    if (params.get('error') === 'validation') {
        if (box) box.innerHTML = '<div class="alert alert-danger">Veuillez corriger les champs invalides avant de confirmer.</div>';
    }
    ...
    //    et qu'une méthode de paiement a été sélectionnée.
